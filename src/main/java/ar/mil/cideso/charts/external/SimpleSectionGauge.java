package ar.mil.cideso.charts.external;
...
public class SimpleSectionGauge extends Region {
    ...
    public SimpleSectionGauge(
            ...
            final Color BAR_BACKGROUND_COLOR,
            final boolean SECTIONS_VISIBLE,
    ...
    public ReadOnlyDoubleProperty valueProperty() {
        return model.currentValueProperty();
    }
    ...
    public boolean getSectionsVisible() {
        return model.getSectionsVisible();
    }
    ...
    public BooleanProperty sectionsVisibleProperty() {
        return model.sectionsVisibleProperty();
    }

    public Color getBarColor() {
        return model.getBarColor();
    }
